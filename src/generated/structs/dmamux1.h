 ...
 * DMAMUX
 */
struct [[gnu::packed]] dmamux1
{
    /* Constant attributes. */
    static constexpr std::size_t size = 128; /*!< dmamux1's size in bytes. */
...
static_assert(sizeof(dmamux1) == dmamux1::size);

static volatile dmamux1 *const DMAMUX1 =
    reinterpret_cast<dmamux1 *>(0x40C18000);
